<!-- SIDE NAVIGATION -->
<aside class="sidenav">
<a href="index.php"><img src="assets/img/codingpro.png" style="height:100px;"></a>
	<a class="active" href="index.php">HTML Home</a>
	<a target="_top" href="history.php">HTML History</a>
	<a target="_top" href="introduction.php">HTML Introduction</a>
	<a target="_top" href="text-editors.php">HTML Editors</a>
